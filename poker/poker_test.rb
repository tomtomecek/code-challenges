...
class PokerTest < Minitest::Test
  ...
  def test_another_two_double_pairs
    double_pair_2_and_K = %w(2S KH 2S KD JH)
    double_pair_J_and_Q = %w(JS QH JS 8D QH)
    game = Poker.new([double_pair_2_and_K, double_pair_J_and_Q])
    assert_equal [double_pair_2_and_K], game.best_hand
  end
