...
- takes an integer which defines the length of a serie
- Raise an error in case of wrong input of length
Serie must consist of consecutive numbers - not random

Output
- returns a collection, where each element will be a serie
- a serie will be an array
...
Algorithm
- slice the string number, the length of each slice is the lenght of series
=end
